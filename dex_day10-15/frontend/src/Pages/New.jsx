...
// Define the faucet contract ABI and address
const faucetABI = [
...
const faucetAddress = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0"; // Replace with your deployed faucet contract address on Anvil
...
const Faucet = () => {
  ...
  const fetchBalances = async () => {
    try {
      ...
      const [balanceA, balanceB] = await faucetContract.getFaucetBalance();
      setBalanceA(ethers.formatUnits(balanceA, 18));
      setBalanceB(ethers.formatUnits(balanceB, 18));
    } catch (err) {
      console.error(err);
